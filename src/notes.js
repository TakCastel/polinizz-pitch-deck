...
const notes = [
  ...
  // 7 — Business model
  "Le modèle économique, je l'ai voulu simple : gratuit pour le public, freemium pour les organisateurs. 19,99 euros par mois pour l'offre Pro, 249,99 euros pour l'offre Pro+ avec un accompagnement dédié. Si on prend une croissance organique réaliste, churn inclus, on part de 10 clients Pro et un client Pro+ le premier mois, et on arrive à 82 clients Pro et 3 clients Pro+ dès le sixième mois, ce qui représente déjà près de 2 400 euros de revenu récurrent mensuel. Et parce que Polinizz butine, 1 % du chiffre d'affaires sera reversé chaque année aux apiculteurs.",
